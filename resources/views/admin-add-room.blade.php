...
<div class="form-wrapper">
  <div class="form-card">
    ...
    <form action="{{ route('admin.room.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" name="room_number" value="{{ old('room_number') }}" placeholder="e.g. 103" required />
      ...
      <input type="number" name="price" value="{{ old('price') }}" placeholder="e.g. 2500" required />

      <label>Description</label>
      <textarea name="description" placeholder="Write room description...">{{ old('description') }}</textarea>
